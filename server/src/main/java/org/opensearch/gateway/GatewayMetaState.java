        ...
        public String uploadIndexMetadataState(ClusterState clusterState) {
            ...
            try {
                if (shouldWriteFullIndexMetadataState()) {
                    manifestInfo = remoteClusterStateService.writeFullIndexMetadata(clusterState);
                } else {
                ...
                logger.info("Setting last accepted IndexMetadata Manifest Version to " +  manifestInfo.getManifestVersion());

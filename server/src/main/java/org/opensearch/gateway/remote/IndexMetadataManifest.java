...
public class IndexMetadataManifest implements Writeable, ToXContentFragment {
    ...
    private static final ParseField INDEX_CHECKSUM_FIELD = new ParseField("index_checksum");

    private static final ConstructingObjectParser<IndexMetadataManifest, Void> PARSER_V1 = new ConstructingObjectParser<>(
        "index_metadata_manifest",
        fields -> manifestV1Builder(fields).build()
    );

    private static final ConstructingObjectParser<IndexMetadataManifest, Void> PARSER_V2 = new ConstructingObjectParser<>(
        "index_metadata_manifest",
        fields -> manifestV2Builder(fields).build()
    );

    private static final ConstructingObjectParser<IndexMetadataManifest, Void> PARSER = PARSER_V2;

    static {
        declareParser(PARSER_V1, CODEC_V1);
        declareParser(PARSER_V2, MANIFEST_CURRENT_CODEC_VERSION);
    }
    ...
    private static void declareParser(ConstructingObjectParser<IndexMetadataManifest, Void> parser, int codecVersion) {
        ...
        parser.declareObject(
            ConstructingObjectParser.optionalConstructorArg(),
            (p, c) -> IndexStateChecksum.fromXContent(p),
            INDEX_CHECKSUM_FIELD
        );
    }
    ...
    private final IndexStateChecksum indexChecksum;
    ...
    public IndexMetadataManifest(
        ...
        IndexStateChecksum indexChecksum
    ) {
    ...
    public IndexMetadataManifest(StreamInput in) throws IOException {
        ...
        this.indexChecksum = in.readOptionalWriteable(IndexStateChecksum::new);
    }
    ...
    public IndexStateChecksum getIndexChecksum() {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeOptionalWriteable(indexChecksum);
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (indexChecksum != null) {
            builder.startObject(INDEX_CHECKSUM_FIELD.getPreferredName());
            indexChecksum.toXContent(builder, params);
            builder.endObject();
        }
    ...
    private static IndexMetadataManifest.Builder manifestV2Builder(Object[] fields) {
        return manifestV1Builder(fields);
    }

    private static IndexMetadataManifest.Builder manifestV1Builder(Object[] fields) {
        return IndexMetadataManifest.builder()
            ...
            .indexChecksum(indexChecksum(fields));
    }
    ...
    private static IndexStateChecksum indexChecksum(Object[] fields) {
        return (IndexStateChecksum) fields[5];
    }
    ...
    public static class Builder {
        ...
        private IndexStateChecksum indexChecksum;
        ...
        public Builder(IndexMetadataManifest manifest) {
            ...
            this.indexChecksum = manifest.indexChecksum;
        }
        ...
        public Builder indexChecksum(IndexStateChecksum indexChecksum) {
            this.indexChecksum = indexChecksum;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        return codecVersion == that.codecVersion
            ...
            && Objects.equals(indexChecksum, that.indexChecksum);
    }

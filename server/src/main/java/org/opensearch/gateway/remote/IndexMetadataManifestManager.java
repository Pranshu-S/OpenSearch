...
public class IndexMetadataManifestManager {
    ...
    public String uploadIndexMetadataManifest(
        ...
        boolean hasIndexChanges
    ) throws IOException {
        // Only skip upload if there are no changes AND we have a previous version
        if (!hasIndexChanges && lastUploadedIndexManifestVersion != null) {
        ...
        IndexStateChecksum indexChecksum = new IndexStateChecksum(

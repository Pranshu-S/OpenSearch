...
public final class RepositoriesModule {
    ...
    public RepositoriesModule(
        ...
        this(env, repoPlugins, transportService, clusterService, threadPool, namedXContentRegistry, recoverySettings, Collections.emptyList());
    }
    ...
    public RepositoriesModule(
        ...
        NamedXContentRegistry namedXContentRegistry,
        RecoverySettings recoverySettings,
        List<BlobContainerInterceptorPlugin> blobContainerInterceptorPlugins
    ) {
        ...
        repositoriesService = new RepositoriesService(
            ...
            threadPool,
            blobContainerInterceptorPlugins
        );
    }
